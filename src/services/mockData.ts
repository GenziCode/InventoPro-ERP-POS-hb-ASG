...
import { InventoryItem, Customer, Sale, Vendor, PurchaseOrder, Payment, Expense } from '../types';
...
export const mockVendors: Vendor[] = [
  { VendorID: 'V001', Name: 'Auto Parts International', ContactPerson: 'Sarah Chen', Email: 'sarah.c@api.com', Phone: '111-222-3333', Category: 'Engine Parts' },
  { VendorID: 'V002', Name: 'Global Tire Co.', ContactPerson: 'Mike Rivera', Email: 'mike.r@globaltire.com', Phone: '111-222-4444', Category: 'Tires' },
  { VendorID: 'V003', Name: 'Brake Systems Inc.', ContactPerson: 'David Lee', Email: 'david.l@brakesys.com', Phone: '111-222-5555', Category: 'Brakes' },
];

export const mockPurchaseOrders: PurchaseOrder[] = [
  { PO_ID: 'PO-001', VendorName: 'Auto Parts International', Date: '2023-10-20', Items: [{ productName: 'NGK Spark Plug', quantity: 100, cost: 7.50 }], Total: 750, Status: 'Received' },
  { PO_ID: 'PO-002', VendorName: 'Brake Systems Inc.', Date: '2023-10-22', Items: [{ productName: 'Brembo Brake Pads', quantity: 50, cost: 60.00 }], Total: 3000, Status: 'Pending' },
  { PO_ID: 'PO-003', VendorName: 'Global Tire Co.', Date: '2023-10-15', Items: [{ productName: 'Michelin Pilot Sport 4S', quantity: 20, cost: 220.00 }], Total: 4400, Status: 'Received' },
];

export const mockPayments: Payment[] = mockSales.map(sale => ({
  PaymentID: `PAY-${sale.SaleID}`,
  SaleID: sale.SaleID,
  Date: sale.Date,
  Amount: sale.Total,
...
export const mockExpenses: Expense[] = [
  { ExpenseID: 'E001', Date: '2023-10-01', Category: 'Rent', Description: 'October Warehouse Rent', Amount: 5000 },
  { ExpenseID: 'E002', Date: '2023-10-05', Category: 'Utilities', Description: 'Electricity Bill', Amount: 850 },
  { ExpenseID: 'E003', Date: '2023-10-15', Category: 'Salaries', Description: 'Bi-weekly Payroll', Amount: 12500 },
  { ExpenseID: 'E004', Date: '2023-10-18', Category: 'Supplies', Description: 'Office and Cleaning Supplies', Amount: 300 },
];
